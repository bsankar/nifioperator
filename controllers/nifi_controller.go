...
// +kubebuilder:rbac:groups=data.nifi.site,resources=nifis,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=data.nifi.site,resources=nifis/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=data.nifi.site,resources=nifis/finalizers,verbs=update
...
func (r *NifiReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("nifi", req.NamespacedName)
